...
"""autogenerated by genpy from acl_msgs/ImageObj.msg. Do not edit."""
import codecs
import sys
...
class ImageObj(genpy.Message):
  _md5sum = "a3ec7fe707760e4afc6563ba0aa58531"
  _type = "acl_msgs/ImageObj"
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','acl_msgs/ImageRect[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.class_string = str[start:end].decode('utf-8', 'rosmsg')
        else:
