...
"""autogenerated by genpy from acl_msgs/QuadPathArray.msg. Do not edit."""
import codecs
import sys
...
class QuadPathArray(genpy.Message):
  _md5sum = "dafc4bcdd4e632ce5732db918109211e"
  _type = "acl_msgs/QuadPathArray"
...
float64[] y
"""
  __slots__ = ['header','path_array']
  _slot_types = ['std_msgs/Header','acl_msgs/QuadPath[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(QuadPathArray, self).__init__(*args, **kwds)
