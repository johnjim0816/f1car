...
"""autogenerated by genpy from acl_msgs/BroadcastTrajectoryActionGoal.msg. Do not edit."""
import codecs
import sys
...
class BroadcastTrajectoryActionGoal(genpy.Message):
  _md5sum = "301b27f494fa54c61ca9334cbdb729a3"
  _type = "acl_msgs/BroadcastTrajectoryActionGoal"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','acl_msgs/BroadcastTrajectoryGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BroadcastTrajectoryActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = acl_msgs.msg.BroadcastTrajectoryGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = acl_msgs.msg.BroadcastTrajectoryGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.goal.trajectory.pos)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.trajectory.pos:
        _v1 = val1.header
        _x = _v1.seq
      ...
      length = len(self.goal.trajectory.vel)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.trajectory.vel:
        _v4 = val1.header
        _x = _v4.seq
        buff.write(_get_struct_I().pack(_x))
        _v5 = _v4.stamp
        ...
        _x = _v6
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.goal.trajectory.acc)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.trajectory.acc:
        _v7 = val1.header
        _x = _v7.seq
        buff.write(_get_struct_I().pack(_x))
        _v8 = _v7.stamp
        ...
        _x = _v9
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.goal.trajectory.jerk)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.trajectory.jerk:
        _v10 = val1.header
        _x = _v10.seq
        buff.write(_get_struct_I().pack(_x))
        _v11 = _v10.stamp
        ...
        _x = _v12
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      _x = self.goal.relative_starting_coordinates
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.goal.trajectory.pos.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.trajectory.vel = []
      for i in range(0, length):
        val1 = geometry_msgs.msg.Vector3Stamped()
        _v16 = val1.header
        start = end
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.goal.trajectory.vel.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.trajectory.acc = []
      for i in range(0, length):
        val1 = geometry_msgs.msg.Vector3Stamped()
        _v19 = val1.header
        start = end
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.goal.trajectory.acc.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.trajectory.jerk = []
      for i in range(0, length):
        val1 = geometry_msgs.msg.Vector3Stamped()
        _v22 = val1.header
        start = end
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.goal.trajectory.jerk.append(val1)
      start = end
      end += 1
      (self.goal.relative_starting_coordinates,) = _get_struct_B().unpack(str[start:end])
      self.goal.relative_starting_coordinates = bool(self.goal.relative_starting_coordinates)
      return self
