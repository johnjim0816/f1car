...
"""autogenerated by genpy from acl_msgs/Return2StartActionResult.msg. Do not edit."""
import codecs
import sys
...
class Return2StartActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "acl_msgs/Return2StartActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','acl_msgs/Return2StartResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Return2StartActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = acl_msgs.msg.Return2StartResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = acl_msgs.msg.Return2StartResult()
