...
"""autogenerated by genpy from acl_msgs/BroadcastTrajectoryGoal.msg. Do not edit."""
import codecs
import sys
...
class BroadcastTrajectoryGoal(genpy.Message):
  _md5sum = "bb87a26e42509a1a023ac20a2d51a6d6"
  _type = "acl_msgs/BroadcastTrajectoryGoal"
...
float64 y
float64 z"""
  __slots__ = ['trajectory','relative_starting_coordinates']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       trajectory,relative_starting_coordinates
    ...
    """
    if args or kwds:
      super(BroadcastTrajectoryGoal, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.trajectory is None:
        self.trajectory = acl_msgs.msg.Trajectory()
      if self.relative_starting_coordinates is None:
        self.relative_starting_coordinates = False
    else:
      self.trajectory = acl_msgs.msg.Trajectory()
      self.relative_starting_coordinates = False
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.trajectory.jerk:
        ...
        _x = _v12
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      _x = self.relative_starting_coordinates
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.relative_starting_coordinates,) = _get_struct_B().unpack(str[start:end])
      self.relative_starting_coordinates = bool(self.relative_starting_coordinates)
      return self
