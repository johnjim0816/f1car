...
class ImageObj {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.obj.forEach((val) => {
      bufferOffset = ImageRect.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.obj[i] = ImageRect.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.obj.forEach((val) => {
      length += ImageRect.getMessageSize(val);
    });
    return length + 8;
  }
  ...
  static datatype() {
    ...
    return 'acl_msgs/ImageObj';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'a3ec7fe707760e4afc6563ba0aa58531';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ImageObj(null);
    ...
    if (msg.obj !== undefined) {
      ...
      for (let i = 0; i < resolved.obj.length; ++i) {
        resolved.obj[i] = ImageRect.Resolve(msg.obj[i]);
      }
    }
    else {
      resolved.obj = []
