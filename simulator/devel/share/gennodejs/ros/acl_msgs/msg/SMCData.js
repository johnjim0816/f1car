...
class SMCData {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('integrator')) {
        this.integrator = initObj.integrator
      }
      else {
        this.integrator = new geometry_msgs.msg.Vector3();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [integrator]
    bufferOffset = geometry_msgs.msg.Vector3.serialize(obj.integrator, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [integrator]
    data.integrator = geometry_msgs.msg.Vector3.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.integrator !== undefined) {
      resolved.integrator = geometry_msgs.msg.Vector3.Resolve(msg.integrator)
    }
    else {
      resolved.integrator = new geometry_msgs.msg.Vector3()
    }
