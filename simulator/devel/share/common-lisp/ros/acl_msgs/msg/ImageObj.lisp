...
(cl:defclass <ImageObj> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (obj
    :reader obj
    :initarg :obj
    :type (cl:vector acl_msgs-msg:ImageRect)
   :initform (cl:make-array 0 :element-type 'acl_msgs-msg:ImageRect :initial-element (cl:make-instance 'acl_msgs-msg:ImageRect))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ImageObj>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageObj)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name acl_msgs-msg:<ImageObj> is deprecated: use acl_msgs-msg:ImageObj instead.")))
...
(cl:defmethod type-val ((m <ImageObj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader acl_msgs-msg:type-val is deprecated.  Use acl_msgs-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'obj-val :lambda-list '(m))
(cl:defmethod obj-val ((m <ImageObj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader acl_msgs-msg:obj-val is deprecated.  Use acl_msgs-msg:obj instead.")
  (obj m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ImageObj>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'obj)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'acl_msgs-msg:ImageRect))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ImageObj>)))
  ...
  "a3ec7fe707760e4afc6563ba0aa58531")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ImageObj)))
  "Returns md5sum for a message object of type 'ImageObj"
  "a3ec7fe707760e4afc6563ba0aa58531")
