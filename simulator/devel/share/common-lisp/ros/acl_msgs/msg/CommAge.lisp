...
(cl:defmethod cl:initialize-instance :after ((m <CommAge>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommAge)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name acl_msgs-msg:<CommAge> is deprecated: use acl_msgs-msg:CommAge instead.")))
...
(cl:defmethod vicon_age_secs-val ((m <CommAge>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader acl_msgs-msg:vicon_age_secs-val is deprecated.  Use acl_msgs-msg:vicon_age_secs instead.")
  (vicon_age_secs m))

(cl:ensure-generic-function 'goal_age_secs-val :lambda-list '(m))
(cl:defmethod goal_age_secs-val ((m <CommAge>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader acl_msgs-msg:goal_age_secs-val is deprecated.  Use acl_msgs-msg:goal_age_secs instead.")
  (goal_age_secs m))
