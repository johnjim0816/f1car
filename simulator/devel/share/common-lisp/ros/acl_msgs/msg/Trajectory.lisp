...
(cl:defmethod cl:initialize-instance :after ((m <Trajectory>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trajectory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name acl_msgs-msg:<Trajectory> is deprecated: use acl_msgs-msg:Trajectory instead.")))
...
(cl:defmethod acc-val ((m <Trajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader acl_msgs-msg:acc-val is deprecated.  Use acl_msgs-msg:acc instead.")
  (acc m))
