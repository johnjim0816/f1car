...
(cl:defmethod cl:initialize-instance :after ((m <QuadFlightMode>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QuadFlightMode)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name acl_msgs-msg:<QuadFlightMode> is deprecated: use acl_msgs-msg:QuadFlightMode instead.")))
