...
(cl:defmethod cl:initialize-instance :after ((m <FloatStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FloatStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name acl_msgs-msg:<FloatStamped> is deprecated: use acl_msgs-msg:FloatStamped instead.")))
...
(cl:defmethod data-val ((m <FloatStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader acl_msgs-msg:data-val is deprecated.  Use acl_msgs-msg:data instead.")
  (data m))
